...
import sul.sul_protocol_1.Fragment3.DrawerPage_Expand;
import sul.sul_protocol_1.Fragment3.GroupBean;
import sul.sul_protocol_1.Fragment3.GroupDBHelper;
import sul.sul_protocol_1.Fragment3.GroupFriendMaps2Activity2;
...
public class ThreadActivity extends Fragment  {
    ...
    private static String u_x; // 위도
    private static String u_y; // 경도
    private static String u_id = UserBean.getId(); // 이 기기의 아이디
