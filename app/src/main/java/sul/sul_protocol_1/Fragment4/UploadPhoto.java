...
public class UploadPhoto extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //editTextuid.setText(UserBean.getId());
        editTextuid.setText(id);
        editTextuid.setEnabled(false);

        //u_id = editTextuid.getText().toString();
    ...
    public void encodeImagetoString() {
        AsyncTask<Void, Void, String> image = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                bitmap = BitmapFactory.decodeFile(imgPath,
                        options);
                bitmap = resizeBitmapImageFn(bitmap, 50);
    ...
    public void triggerImageUpload() throws UnsupportedEncodingException {
        makeHTTPCall();
    ...
    public void makeHTTPCall() throws UnsupportedEncodingException {
        prgDialog.setMessage("Invoking Php");
        AsyncHttpClient client = new AsyncHttpClient();
        // Don't forget to change the IP address to your LAN address. Port no as well.
        client.post("http://sul.duksung.ac.kr/upload_image.php",
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "Photo2 Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app deep link URI is correct.
                Uri.parse("android-app://sul.sul_protocol_1.Fragment0/http/host/path")
        );
